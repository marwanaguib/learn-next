...
/* harmony import */ var _actions_posts_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../actions/posts.js */ "./actions/posts.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initPosts;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case _actions_posts_js__WEBPACK_IMPORTED_MODULE_1__["GET_POSTS"]:
...
function initializeStore(initialState) {
  var final_middleware;

  if (true) {
    // if development let action appear in console.log
    // final_middleware = applyMiddleware(thunkMiddleware,logger);
    final_middleware = Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(redux_thunk__WEBPACK_IMPORTED_MODULE_1___default.a, redux_logger__WEBPACK_IMPORTED_MODULE_3___default.a);
  } else {}

  return Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(_reducers__WEBPACK_IMPORTED_MODULE_2__["default"], initialState, final_middleware);
}
